...
Você precisará criar uma conexão de serviço no Azure DevOps, que permitirá implantar e acessar recursos em sua assinatura do Azure.

1. Inicie um navegador da Web e navegue até o portal do Azure DevOps em `https://aex.dev.azure.com`.

1. Conecte-se à organização do Azure DevOps.

   > **Observação**: se esta for a primeira vez que você estiver se conectando à organização do Azure DevOps, será solicitado que você crie seu perfil e aceite os termos de serviço, em seguida, clique em **Continuar**.

1. Abra o projeto **eShopOnWeb** e clique em **Configurações do projeto** no canto inferior esquerdo do portal.

1. Em Pipelines, selecione **Conexões de serviço** e, em seguida, selecione o botão **Criar conexão de serviço**.

   ![Captura de tela do botão de criação da nova conexão de serviço.](images/new-service-connection.png)
