...
1. Verifique se o navegador da Web exibe sua organização do Azure DevOps com o **projeto EShopOnWeb** gerado no exercício anterior.

    > **Observação**: como alternativa, você pode acessar a página do projeto diretamente navegando até a URL [<https://dev.azure.com/>`<your-Azure-DevOps-account-name>`/EShopOnWeb), onde o espaço reservado representa o nome da `<your-Azure-DevOps-account-name>` sua conta.

2. Clique no ícone de engrenagem rotulado **Configurações do projeto** localizado no canto inferior esquerdo da página **Configurações do projeto**.

    ![Janela de projeto do Azure DevOps. Clique na opção “Configurações do projeto”](images/m1/project_settings_v1.png)

3. Na seção **Geral** selecione a guia **Teams** Já existe uma equipe padrão neste projeto, **Equipe EShopOnWeb** mas você criará uma nova para este laboratório. Clique em **Nova equipe**.

    ![Na janela de configurações do projeto, guia "Teams", clique em "Nova equipe"](images/m1/new_team_v1.png)

4. No painel **Criar uma nova equipe** na caixa de texto **Nome da equipe** digite, **EShop-Web**, deixe outras configurações com seus valores padrão e clique em **Criar**.

    ![Na janela "criar uma nova equipe", chame sua nova equipe de "EShop-Web" e clique em "Criar"](images/m1/eshopweb-team_v1.png)

5. Na lista de **Equipes**, selecione a equipe recém-criada para exibir seus detalhes.
...
6. Clique no **link Caminhos** de Área e Iterações na parte superior da **página do EShop-Web** para começar a definir a agenda e o escopo da equipe.
...
7. Na parte superior do painel **Boards** selecione a guia **Iterações** e, em seguida, clique em **+ Selecionar iteração(ões)**.

    ![Na guia "iterações", clique em "Selecionar iteração"](images/m1/EShop-WEB-select_iteration_v1.png)

8. Selecione **EShopOnWeb\Sprint 1** e clique em **Salvar e fechar**. Observe que esse primeiro sprint aparecerá na lista de iterações, mas as Datas ainda não estão definidas.
9. Selecione **Sprint 1** e clique nas **reticências (...)**. No menu de contexto, selecione **Editar**.
...
10. Repita a etapa anterior para adicionar **o Sprint 2** e **o Sprint 3**. Pode-se dizer que estamos na 2ª semana do primeiro sprint.
...
2. Na janela Itens de **Trabalho** , clique em **+ Novo Item de Trabalho > Épico**.

    ![Na janela "Boards">"Itens de trabalho", clique em + Novo Item de Trabalho > Épico](images/m1/EShop-WEB-create_epic_v1.png)

3. **Na caixa de texto Inserir título**, digite **Treinamento do**produto.
4. No canto superior esquerdo, selecione a entrada **Não atribuída** e, na lista suspensa, selecione sua conta de usuário para atribuir o novo item de trabalho a você mesmo.
5. Ao lado da **entrada Área** , selecione a **entrada eShopOnWeb** e, na lista suspensa, selecione **EShop-WEB**. Isso definirá a **Área** como **eShopOnWeb\EShop-WEB.**
6. Ao lado da **entrada Interação** , selecione a **entrada eShopOnWeb** e, na lista suspensa, selecione **Sprint 2**. Isso definirá a **Interação** como **eShopOnWeb\Sprint 2**
7. Clique em **Salvar** para finalizar suas alterações. **Não o feche**.
...
13. No painel **Boards**, no canto superior direito, selecione a entrada Lista de pendências** da ** e, na lista suspensa, selecione **Recursos**.

    > **Observação**: isso facilitará a adição de tarefas e outros itens de trabalho aos recursos.

14. Passe o ponteiro do mouse sobre o retângulo que representa o recurso Dashboard de**treinamento** . Isso revelará o símbolo de reticências (...) em seu canto superior direito.
15. Clique no ícone de reticências (...) e, na lista suspensa, selecione **Adicionar item** de lista de pendências do produto.
...
16. Na caixa de texto do novo item de lista de pendências do produto, digite **Como cliente, desejo exibir novos tutoriais** e pressione a tecla Enter** para salvar a **entrada.
...
17. Repita a etapa anterior para adicionar mais dois PBIs projetados para permitir que o cliente veja seus tutoriais exibidos recentemente e solicite novos tutoriais nomeados, respectivamente, **Como cliente, quero ver tutoriais que visualizei** recentemente e **Como cliente, desejo solicitar novos tutoriais**.

    ![Repita clicando em "Adicionar lista de pendências do produto" ](images/m1/EShop-WEB-pbis_v1.png)

18. No painel **Boards**, no canto superior direito, selecione a entrada Recursos** **e, na lista suspensa, selecione **itens de lista de pendências**.
...
19. **Na guia Board** do **painel EShop-WEB**, arraste o primeiro item de trabalho chamado **Como cliente, desejo visualizar novos tutoriais** da **etapa Novo** para **Aprovado**.
...
20. Passe o ponteiro do mouse sobre o retângulo que representa o item de trabalho movido para o **etapa Aprovado** . Isso revelará o símbolo do acento circunflexo voltado para baixo.
21. Clique no símbolo de acento circunflexo virado para baixo para expandir o cartão de item de trabalho, selecione a entrada Não atribuído** e, na lista de contas de usuário, selecione sua conta para atribuir o PBI movido a **si mesmo.
22. **Na guia Board** do **painel EShop-WEB**, arraste o segundo item de trabalho chamado **Como cliente, desejo visualizar novos tutoriais** da **etapa Novo** para **Confirmado**.
23. **Na guia Board** do **painel EShop-WEB**, arraste o terceiro item de trabalho chamado **Como cliente, desejo solicitar novos tutoriais** da **etapa Novo** para **Pronto**.
...
24. **Na guia Board** do **painel EShop-WEB**, na parte superior do painel, clique em **Exibir como pendência** para exibir o formulário tabular.
...
25. **Na guia Lista de pendências** do painel EShop-WEB **, no canto superior esquerdo do painel, clique no segundo sinal de adição na parte superior, aquele ao lado do **primeiro item de trabalho. Isso exibirá o **painel NOVA TAREFA** .

    ![Clique em "+" para criar a Tarefa](images/m1/new_task_v1.png)

26. Na parte superior do **painel NOVA TAREFA** , na **caixa de texto Inserir título**, digite **Adicionar página para os tutoriais** mais recentes.
27. **No painel NOVA TAREFA**, na **caixa de texto Trabalho** Restante, digite **5**.
28. No painel **NOVA TAREFA,** na lista suspensa **Atividade** selecione **Desenvolvimento**.
29. No painel **NOVA TAREFA** clique em **Salvar e Fechar**.

    ![Preencha os campos "Nova tarefa" e clique em "Salvar e Fechar"](images/m1/EShop-WEB-save_task_v1.png)

30. Repita as últimas cinco etapas para adicionar outra tarefa chamada **Otimizar consulta de dados para os tutoriais mais recentes**. Defina seu **Trabalho Restante** como **3** e sua **Atividade** como **Design**. Clique em **Salvar e Fechar** depois de concluído.
...
8. De volta à guia **Capacidade** da visualização**Sprints**clique em **Salvar**.
9. Selecione o **guia Quadro de Tarefas** do modo de **** exibição Sprints.
...
10. Na guia **Quadro de Tarefas** do modo de exibição **Sprints**, na caixa quadrada que representa a página **Adicionar para tutoriais mais recentes**, defina o número estimado de horas como **14**, para corresponder à sua capacidade total para essa sprint, que você identificou na etapa anterior.
...
12. Clique no **ícone Configurar engrenagem de configurações** da equipe (diretamente à direita do ícone do funil).
13. No painel **Configurações** selecione a guia **Estilos,** clique em **+ regra de estilo**, na etiqueta **Nome da regra,** na caixa de texto **Nome** digite **Desenvolvimento**, e, na lista suspensa **Cor do cartão** selecione o retângulo verde.
...
14. Na seção **Critérios de** regra, na **lista suspensa**, selecione **Atividade **, na lista suspensa**Operador**, selecione**=**, e, na lista suspensa **Valor** selecione **Desenvolvimento**.
...
16. Na página **Configurações**, selecione a guia **Número de dias úteis**.
...
17. Na página **Configurações**, selecione a guia **Trabalhando com bugs**.

    > **Observação**: as entradas nesta guia permitem que você especifique como os bugs são apresentados no quadro.

18. No painel **Configurações**, clique em **Salvar e fechar** para salvar a regra de estilo.
...
3. No painel **Configurações** selecione a guia **Cores de marcação** clique em **+ Cor da marcação**, na caixa de texto **Marcação** digite **dados** e deixe a cor padrão no lugar.
...
5. Na página **Configurações**, selecione a guia **Lista de Testes**.
...
14. Clique em **+ Coluna**, com **na etiqueta nome da Coluna**, na caixa de texto **Nome**, digite **QA Aprovado** e na caixa de texto **Limite de WIP **, digite **1**
...
23. Na guia QA **Aprovado** , habilite a caixa de **seleção Dividir coluna em fazer e concluído** para criar duas colunas separadas.
...
24. Na guia QA **Aprovado** , na parte inferior do painel, na **caixa de texto Definição de concluído** , digite **Passa \*\*em todos os\*\* testes**.
25. No painel **Configurações**, clique em **Salvar e fechar**.
...
2. Clique no botão **Configuração da organização** no canto inferior esquerdo da página.
3. No menu vertical Configurações** da**Organização, na **seção Boards**, selecione **Processo**.
4. No painel Todos os **processos**, à direita da entrada do Scrum **, selecione o símbolo de **reticências (...) e, no menu suspenso, selecione **Criar processo** herdado.
...
5. **No painel Criar processo herdado do Scrum**, na caixa de **texto Nome do processo (obrigatório),** digite **Scrum** personalizado e clique em **Criar processo**.
6. De volta ao painel Todos os **processos**, clique na **entrada Scrum** personalizado.

    > **Observação**: talvez seja necessário atualizar o navegador para que o novo processo fique visível.

7. No painel Todos os **processos > Scrum** personalizado, selecione **Item** de lista de pendências do produto.
...
8. No painel Todos os **processos > Item de lista de pendências** personalizadas do Scrum > do produto, clique em **Novo campo**.
9. No painel **Adicionar um campo ao Item de Lista de Pendências do Produto**, na guia **Definição**, na seção **Criar um campo**, na caixa de texto **Nome**, digite **ID do Ticket EShop**.
...
10. **No painel Adicionar um campo ao Item** de Lista de Pendências do Produto, clique em **Layout**.
11. No painel **Adicionar um campo ao Item de Lista de Pendências do Produto** na guia **Layout**, na caixa de texto **Etiqueta**, digite **ID do Ticket **, selecione a opção**Criar um novo grupo**, na caixa de texto **Grupo** digite **EShopOnWeb**, e clique em **Adicionar campo**.
...
12. Retorne à raiz **Todos os processos** usando o caminho de trilha na parte superior do painel **Todos os processos > Scrum personalizado > item de lista de pendências de produto**.
13. No painel **Todos os processos**, clique na **entrada Scrum** personalizado.
...
14. No painel **Todos os processos > Scrum**, selecione a guia **Projetos**.
15. Na lista de projetos, na linha que contém a **entrada eShopOnWeb**, selecione o símbolo de reticências (...) e, em seguida, selecione **Alterar processo**.
16. No painel **Alterar o processo do projeto**, na lista suspensa **Selecionar um processo de destino**, selecione o processo **Scrum Personalizado**, clique em **Salvar** e, em seguida, clique em **Fechar**.
...
17. Clique no logotipo do **Azure DevOps** no canto superior esquerdo para navegar até a página raiz da conta.
18. **Na guia Projetos**, selecione a entrada que representa o **projeto eShopOnWeb**.
19. No menu vertical no lado esquerdo da página **eShopOnWeb** selecione **Boards** verifique se o painel **Itens de Trabalho** é exibido.
20. Na lista de itens de trabalho, clique no primeiro item de lista de pendências.
21. Verifique se agora você tem o **campo ID ** do ticket no grupo **eShopOnWeb** que foi definido durante a personalização do processo Você pode tratar isso como qualquer outro campo de texto.
...
2. Se necessário, no painel **Dashboards** no canto superior esquerdo, na seção Equipe do **eShopOnWeb**, selecione **Equipe do eShopOnWeb - Visão Geral** e revise o dashboard existente.
...
3. **No painel Dashboards**, selecione o menu suspenso ao lado do **título Equipe eShopOnWeb - Visão geral** e selecione **+ Novo painel**.
...
4. No painel **Criar um dashboard**, na caixa de texto **Nome**, digite **Treinamento do produto**, na lista suspensa **Equipe**, selecione a equipe do **EShop-WEB**, e clique em **Criar**.
...
5. No novo painel do dashboard, clique em **Adicionar um widget**.
6. **No painel Adicionar widget**, na **caixa de texto Pesquisar**, digite **sprint** para localizar widgets existentes que se concentram em sprints. Na lista de resultados, selecione **Visão geral** da Sprint e clique em **Adicionar**.
7. No retângulo que representa o widget recém-adicionado, clique no ícone de engrenagem Configurações **** e revise o **painel Configuração**.

    > **Observação**: o nível de personalização varia de acordo com o widget.

8. **No painel Configuração**, clique em **Fechar** sem fazer alterações.
9. De volta ao **painel Adicionar widget**, na **caixa de texto Pesquisar**, digite **sprint** para localizar widgets existentes que se concentram em sprints. Na lista de resultados, selecione **Capacidade** da Sprint e clique em **Adicionar**.
10. **No modo de exibição Dashboard**, na parte superior do painel, clique em **Edição concluída**.
...
11. No painel de navegação vertical do portal do Azure DevOps, selecione o ícone **Boards** e, na lista de itens **Boards**, selecione **Consultas**.
12. No painel **Consultas**, clique em **+ Nova Consulta**.
13. Na guia**Editor** do painel **Consultas > Minhas Consultas**, na lista suspensa **Valor** da linha **Tipo de item de trabalho **, selecione **a Tarefa**.
14. Na guia **Editor** de **Consultas > Minhas Consultas**, na segunda linha, na coluna **Campo**, selecione **Caminho da Área** e, na lista suspensa correspondente **Valor**, selecione **eShopOnWeb\\EShop-WEB**.
15. Clique em **Salvar consulta**
